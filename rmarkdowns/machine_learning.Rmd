...
```{r}
rf_sanita <- randomForest(normalized_score_sdg6_sanita ~ ., data = sdr_data_imputed, importance = TRUE)
...
# Third Output
pdp::partial(rf_sanita, pred.var = "normalized_score_sdg6_sanita", plot = TRUE)

# Fourth Output
pd <- pdp::partial(rf_sanita, pred.var = c("normalized_score_sdg6_sanita", "normalized_score_sdg3_u5mort"))
# Default PDP
plotPartial(pd)
